...
print(" "*6 + "Inside model/llast.py file")
print(" " * 7 + "↓")
print(" " * 7 + "↓")
...
class LLaSTModel(BaseModel):
    ...
    def __init__(
        ...
        super().__init__()
        print(" " * 6 + "inside llastmodel init")
        print(" " * 7 + "↓")
        print(" " * 7 + "↓")
    ...
    def forward(self, data, data_samples=None, mode='loss'):
        #print("data from data_batch: ",data)
        ...
        #print("data from prepare_inputs_labels_for_llast: ", data)
        if mode == 'loss':
    ...
    def compute_loss(self, data, data_samples=None):
        #print("\nType of input data to llm :", type(data))
        #print("\nKeys in input data:", data)
    
        # Pass data to llm
        outputs = self.llm(**data)
    
        # Debug: Check type of outputs from llm
        #print("\nType of outputs:", type(outputs))
        #print("\nOutput of llm: ", outputs.logits)
         
        loss_dict = {'loss': outputs.loss}
        #print("\nloss of model is : ", outputs.loss)
        #print()
        return loss_dict
