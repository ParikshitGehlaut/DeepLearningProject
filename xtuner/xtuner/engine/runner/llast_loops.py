...
class LLaSTTestLoop(TestLoop):
    ...
    def run_iter(self, idx, data_batch: Sequence[dict]) -> None:
        ...
        with autocast(enabled=self.fp16, dtype=torch.float16):
            ...
            print("Speech Encoder output:", audio_outputs)
            ...
            print("Projector output:", audio_tokens)
            ...
            print("Input embeds shape: ", mm_inputs['inputs_embeds'].shape)
            print(f"Inputs embeds: Min = {mm_inputs['inputs_embeds'].min()} Max = {mm_inputs['inputs_embeds'].max()}")
